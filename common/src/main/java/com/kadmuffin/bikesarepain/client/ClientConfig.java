    ...
    public Screen getScreen(Screen parent) {
        return YetAnotherConfigLib.create(CONFIG, ((defaults, config, builder) -> builder.title(Component.literal("Bikes Are Pain Config Screen"))
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                .name(Component.translatable("config.bikesarepain.advanced.raycast.name"))
                                .description(OptionDescription.of(Component.translatable("config.bikesarepain.advanced.raycast.tooltip")))
                                .option(Option.<Integer>createBuilder()
                                        .name(Component.translatable("config.bikesarepain.advanced.raycast.min_ray_wait"))
                                        .description(OptionDescription.of(Component.translatable("config.bikesarepain.advanced.raycast.min_ray_wait.tooltip")))
                                ...
                                .option(Option.<Integer>createBuilder()
                                        .name(Component.translatable("config.bikesarepain.advanced.raycast.max_ray_wait"))
                                        .description(OptionDescription.of(Component.translatable("config.bikesarepain.advanced.raycast.max_ray_wait.tooltip")))
                                ...
                                .option(Option.<Float>createBuilder()
                                        .name(Component.translatable("config.bikesarepain.advanced.raycast.vertical_threshold"))
                                        .description(OptionDescription.of(Component.translatable("config.bikesarepain.advanced.raycast.vertical_threshold.tooltip")))
                                ...
                                .option(Option.<Float>createBuilder()
                                        .name(Component.translatable("config.bikesarepain.advanced.raycast.vertical_sensitivity"))
                                        .description(OptionDescription.of(Component.translatable("config.bikesarepain.advanced.raycast.vertical_sensitivity.tooltip")))
                                ...
                                .option(Option.<Float>createBuilder()
                                        .name(Component.translatable("config.bikesarepain.advanced.raycast.speed_sensitivity"))
                                        .description(OptionDescription.of(Component.translatable("config.bikesarepain.advanced.raycast.speed_sensitivity.tooltip")))
